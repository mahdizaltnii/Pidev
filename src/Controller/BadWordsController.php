...
class BadWordsController extends AbstractController
{
    ...
    {
        return $this->render('Back-office/bad_words/index.html.twig', [
    ...
    public function new(Request $request, BadWordsRepository $badWordsRepository): Response
    {
        ...
        return $this->render('Back-office/bad_words/new.html.twig', [
            'bad_word' => $badWord,
    ...
    {
        return $this->render('Back-office/bad_words/show.html.twig', [
            'bad_word' => $badWord,
        ]);
    }
    ...
    public function edit(Request $request, BadWords $badWord, BadWordsRepository $badWordsRepository): Response
    {
        ...
        return $this->render('back-office/bad_words/edit.html.twig', [
            'bad_word' => $badWord,
            'form' => $form->createView(),
        ]);
    }
